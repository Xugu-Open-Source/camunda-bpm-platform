...
drop index ACT_ID_MEMBERSHIP.ACT_IDX_MEMB_GROUP;
drop index ACT_ID_MEMBERSHIP.ACT_IDX_MEMB_USER;
drop index ACT_ID_TENANT_MEMBER.ACT_IDX_TENANT_MEMB;
drop index ACT_ID_TENANT_MEMBER.ACT_IDX_TENANT_MEMB_USER;
drop index ACT_ID_TENANT_MEMBER.ACT_IDX_TENANT_MEMB_GROUP;
