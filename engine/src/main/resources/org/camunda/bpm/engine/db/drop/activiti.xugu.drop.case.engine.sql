...
drop index ACT_RU_CASE_EXECUTION.ACT_IDX_CASE_EXE_PARENT;
drop index ACT_RU_CASE_EXECUTION.ACT_IDX_CASE_EXE_CASE_DEF;
drop index ACT_RU_VARIABLE.ACT_IDX_VAR_CASE_EXE;
drop index ACT_RU_VARIABLE.ACT_IDX_VAR_CASE_INST_ID;
