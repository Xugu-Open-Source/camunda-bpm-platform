...
drop index ACT_GE_BYTEARRAY.ACT_IDX_BYTEAR_DEPL;
drop index ACT_RU_EXECUTION.ACT_IDX_EXE_ROOT_PROCINST;
drop index ACT_RU_EXECUTION.ACT_IDX_EXE_PROCINST;
drop index ACT_RU_EXECUTION.ACT_IDX_EXE_PARENT;
drop index ACT_RU_EXECUTION.ACT_IDX_EXE_SUPER;
drop index ACT_RU_EXECUTION.ACT_IDX_EXE_PROCDEF;
drop index ACT_RU_IDENTITYLINK.ACT_IDX_TSKASS_TASK;
drop index ACT_RU_TASK.ACT_IDX_TASK_EXEC;
drop index ACT_RU_TASK.ACT_IDX_TASK_PROCINST;
drop index ACT_RU_TASK.ACT_IDX_TASK_PROCDEF;
drop index ACT_RU_VARIABLE.ACT_IDX_VAR_EXE;
drop index ACT_RU_VARIABLE.ACT_IDX_VAR_PROCINST;
drop index ACT_RU_VARIABLE.ACT_IDX_VAR_BYTEARRAY;
drop index ACT_RU_JOB.ACT_IDX_JOB_EXCEPTION;
...
drop index ACT_RU_VARIABLE.ACT_IDX_VARIABLE_TASK_NAME_TYP;
...
drop index ACT_RU_JOB.ACT_IDX_JOB_HANDLER;
...
drop index ACT_RU_EVENT_SUBSCR.ACT_IDX_EVENT_SUBSCR;
drop index ACT_RU_IDENTITYLINK.ACT_IDX_ATHRZ_PROCEDEF;

-- indexes for deadlock problems - https://app.camunda.com/jira/browse/CAM-2567
drop index ACT_RU_INCIDENT.ACT_IDX_INC_CAUSEINCID;
drop index ACT_RU_INCIDENT.ACT_IDX_INC_EXID;
drop index ACT_RU_INCIDENT.ACT_IDX_INC_PROCDEFID;
drop index ACT_RU_INCIDENT.ACT_IDX_INC_PROCINSTID;
drop index ACT_RU_INCIDENT.ACT_IDX_INC_ROOTCAUSEINCID;
drop index ACT_RU_INCIDENT.ACT_IDX_INC_JOB_DEF;
